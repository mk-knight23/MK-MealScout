# Contributing to MK MealScout

Thank you for your interest in contributing to MK MealScout!

## Getting Started

1. Fork the repository
2. Clone your fork: `git clone https://github.com/YOUR-USERNAME/17-web-culinary-discovery.git`
